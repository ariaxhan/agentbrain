# agent-db — Design: every table earns its place
...
A Python package is the enforcer. When AgentDB is a library an agent *calls* rather
...
deterministic consequence of recall + verdict, both of which already flow. AgentDB
